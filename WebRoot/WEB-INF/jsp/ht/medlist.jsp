...
<html>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=8">
	...
	<script type="text/javascript" src="js/medlist.js"></script>
  ...
  <body>
    ...
    <div id="pageleft">
    	<!-- 左侧菜单 -->
    	<div class="left2_1"> <a href="ht/med.do" class="a3">元数据录入</a></div>
    	<div class="left2_1">元数据管理</div>
    </div>
    <div id="center_right">
    	<!-- 右侧内容 -->
		...
		<form action="#" id="savemetadata" method="post">
        	...
        	<tr>
              ...
              <tr>
                ...
                <td>&nbsp; 
                	<input type="hidden" id="mdid" name="id" />
                </td>
              </tr>
              <tr>
